    ...
    return (
        <>
            <div className="fav-btns">
                <button className={movieClicked ? 'clicked' : 'unclicked'} onClick={() => !movieClicked ? setMovieClicked(true) : null}>
                    Favorite Movies
                </button>
                <button className={movieClicked ? 'unclicked' : 'clicked'} onClick={() => movieClicked ? setMovieClicked(false) : null}>
                    Favorite Series
                </button>
            </div>
            <div className="card-container">
                { movieClicked ?
                    favoriteMovies.length === 0 ? <p className='no-fav' >No Movies liked yet!</p> :
                    ...
                    : favoriteSeries.length === 0 ? <p className='no-fav' >No Series liked yet!</p> :
